...
// --- SPLIT FILE ---
  ...
  // Auto track promo param
  const urlParams = new URLSearchParams(window.location.search);
  const promo = urlParams.get('v') || urlParams.get('utm_campaign') || 'direct';
  gtag('event', 'promo_view', {promo_code: promo});
...
const ARMADA_DATA=[{id:'calya',name:'Toyota Calya / Sigra',shortName:'Calya / Sigra',badge:'Ekonomis • 4 Nyaman',image:'assets/images/armada/calya-black-gold.jpg',images:['assets/images/armada/calya-black-gold.jpg','assets/images/armada/calya-white.jpg'],capacity:'4 Nyaman',capacityNum:4,capacityMax:6,baggage:'2 koper kabin kecil',maxInfo:'Max 6 tanpa bagasi',note:'⚠️ Tidak muat 6 + koper besar',noteClass:'text-amber-600',price:550000,span:'lg:col-span-3'},{id:'avanza',name:'Toyota Avanza / Xenia New',shortName:'Avanza / Xenia New',badge:'Paling Laris • 5 Nyaman',image:'assets/images/armada/avanza-black-gold.jpg',images:['assets/images/armada/avanza-black-gold.jpg','assets/images/armada/avanza-white.jpg'],capacity:'5 Nyaman',capacityNum:5,capacityMax:6,baggage:'1 besar + 2 kecil',maxInfo:'Max 6 tanpa koper besar',note:'✅ Muat stroller lipat',noteClass:'text-emerald-600',price:650000,span:'lg:col-span-3'},{id:'xpander',name:'Mitsubishi Xpander',shortName:'Xpander',badge:'MPV Nyaman • 6 Nyaman',image:'assets/images/armada/xpander-black.jpg',images:['assets/images/armada/xpander-black.jpg','assets/images/armada/xpander-white.jpg'],capacity:'6 Nyaman',capacityNum:6,capacityMax:7,baggage:'1 besar + 2 kecil',maxInfo:'Max 7 tanpa bagasi besar',note:'✅ Kabin paling lega',noteClass:'text-emerald-600',price:800000,span:'lg:col-span-3'},{id:'innova',name:'Toyota Innova Reborn / Zenix',shortName:'Innova Reborn / Zenix',badge:'Best Seller • 6 Nyaman',image:'assets/images/armada/innova-black-gold.jpg',images:['assets/images/armada/innova-black-gold.jpg','assets/images/armada/innova-white.jpg'],capacity:'6 Nyaman',capacityNum:6,capacityMax:7,baggage:'2 besar + 2 kecil',maxInfo:'Max 7 tipe G tanpa bagasi besar',note:'✅ Rekomendasi luar kota',noteClass:'text-emerald-600',price:950000,span:'lg:col-span-4'},{id:'hiace',name:'Toyota Hiace Premio',shortName:'Hiace Premio',badge:'Premium • 11 Nyaman',image:'assets/images/armada/hiace-black-gold.jpg',images:['assets/images/armada/hiace-black-gold.jpg','assets/images/armada/hiace-white.jpg'],capacity:'11 Nyaman',capacityNum:11,capacityMax:14,baggage:'8-10 koper besar',maxInfo:'Max resmi 12, modif 14 tanpa bagasi besar',note:'ℹ️ 12 orang = lipat 2 kursi untuk koper',noteClass:'text-slate-500',price:1600000,span:'lg:col-span-8'}];
...
async function fetchWeather(){
  try{
    ...
    document.getElementById('weather-daynight').innerText=isDay?'☀️ Siang':'🌙 Malam';
...
// === FINAL LOGIC 30 DETIK BENAR ===
window.addEventListener('DOMContentLoaded',()=>{
  const h = new Date().getHours();
  const isDay = h >= 5 && h < 19;

  if(isDay){
    setTheme('classic', true); // SIANG buka jam 10 = HITAM 30 detik
  } else {
    setTheme('heritage', false); // MALAM buka jam 20 = PUTIH 30 detik
  }

  setTimeout(()=>{
    if(!userManuallyChangedTheme){
      if(isDay){
        setTheme(themeByTime(), null); // Siang setelah 30 detik = putih sesuai jam
      } else {
        setTheme(themeByTime(), true); // Malam setelah 30 detik = DIPAKSA HITAM
      }
    }
  }, 30 * 1000);
...
const LOGO_MAP={
  classic:'assets/logo/logo_tempera_transparent_fixed.png',
  sky:'assets/logo/logo_sky_blue_transparent.png',
  tropical:'assets/logo/logo_tropical_transparent.png',
  mountain:'assets/logo/tempera_alpine_logo_forest_transparent_fixed.png',
  ocean:'assets/logo/logo_ocean_transparent.png',
  sunset:'assets/logo/logo_sunset_transparent.png',
  minimal:'assets/logo/logo_minimal_transparent.png',
  heritage:'assets/logo/logo_heritage_transparent.png'
};
(function(){
